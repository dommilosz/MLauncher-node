...
function resolveDropinModsForUI(){
    ...
    CACHE_SETTINGS_MODS_DIR = path.join(ConfigManager.getInstanceDirectory(), serv.id, 'mods')
    CACHE_DROPIN_MODS = DropinModUtil.scanForDropinMods(CACHE_SETTINGS_MODS_DIR, serv.minecraftVersion)
    ...
    document.getElementById('settingsSelServContent').innerHTML = `
        ...
        <div class="serverListingDetails">
            ...
            <div class="serverListingInfo">
                <div class="serverListingVersion">${serv.minecraftVersion}</div>
...
function populateJavaExecDetails(execPath){
    const jg = new JavaGuard(DistroManager.getDistribution().getServer(ConfigManager.getSelectedServer()).minecraftVersion)
