...
exports.addAccount = async function (username, password) {
	try {
		if (password == "MC:LEAKS") {
            ...
            var body = '{"token":"' + username.replace("LEAKS_") + '"}';
			req.send(body); /* Argument trzeci, wartość true, określa, że żądanie ma być asynchroniczne */
			if (req.status == 200) {
...
exports.validateSelected = async function () {
	...
	if (!current.online) isValid = true;
	if (!isValid) {
		try {
